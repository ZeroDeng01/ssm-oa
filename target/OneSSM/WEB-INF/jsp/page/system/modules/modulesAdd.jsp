...
<form id="authForm" lay-filter="authForm"  class="layui-form model-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input name="orderNumber" placeholder="请输入排序号" type="number" class="layui-input" value="0" lay-verify="required" required/>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="parentId">
                ...
                <c:forEach items="${list}" var="v">
                    <option value="${v.id}">${v.authorityname}</option>
                </c:forEach>
            </select>
        </div>
    </div>
...
<script>
    layui.use(['layer', 'form', 'admin'], function () {
        ...
        var url = '/System/Modules/modulesAdd.do';
        // 回显数据
