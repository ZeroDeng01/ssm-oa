...
public class makeSql {
    private static final Logger logger = LoggerFactory.getLogger(makeSql.class);

    public static void main(String[] args) {
        //实体类所在的package在磁盘上的绝对路径
        String packageName = "D:/OneSSM/src/main/java/com/zerodeng/bean/system";
        //生成sql的文件夹
        String filePath = "E:/makeSql/";
        //项目中实体类的路径
        String prefix = "com.zerodeng.bean.system.";
        String className = "";
